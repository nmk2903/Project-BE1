                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="list-inline">
                        <li class="list-inline-item">
                          <img alt="Avatar" class="table-avatar" style="border-radius:0%;width:5rem;" src="../img/<?php echo $value["image"]; ?>">
                        </li>
                        <!-- <li class="list-inline-item">
                    ...
                    <td class="project_progress">
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-green" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo 100 - ($value["sold"] / $value["in_stock"] * 100); ?>%">
                        </div>
                      </div>
                      <small>
                        <?php echo $value["in_stock"] - $value["sold"] . "/" . $value["in_stock"]; ?>
                      </small>
                    </td>
