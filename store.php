		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumb-tree">
					...
					<?php
					if ($category == "AllProducts") {
						echo "<li class=\"active\">All Categories " . "(" . number_format(count($totalProduct)) . " Results)" . "</li>";
					} else {
						echo "<li><a href=\"store.php?category=AllProducts\">All Categories</a></li>";
						echo "<li class=\"active\">";
						echo $_GET["category"];
						echo " (" . number_format(count($products)) . " Results)";
						echo "</li>";
					}
					?>
			...
			<div id="store" class="col-md-9">
				...
				<div class="store-filter clearfix">
					...
					<ul class="store-pagination">
						<li><a href="<?php echo "?page=$prevPage" ?>"><i class="fa fa-angle-left"></i></a></li>
						<?php
						if (isset($_GET["page"])) {
							$page = $_GET["page"];
						} else {
						...
						?>
						<li><a href="<?php echo "?page=$nextPage" ?>"><i class="fa fa-angle-right"></i></a></li>
					</ul>
				</div>
				<!-- /store bottom filter -->
			</div>
